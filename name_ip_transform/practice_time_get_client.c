...
int main(int argc, char **arg)
{
    ...
    char service_name[MAX_HOST_NAME] = {0};
    if (getnameinfo((struct sockaddr *)&peer_add, sizeof(peer_add), host_name, MAX_HOST_NAME, service_name, MAX_HOST_NAME, NI_NOFQDN) != 0)
    {
        perror("Get name info failed.\r\n");
        return OK;
    }
    printf("Getnameinfo:\r\n");
